        ...
        <nav id="main-nav" class="navbar navbar-default navbar-fixed-top" role="banner">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html"><img src="images/logo.png" height="72" width="72" alt="logo"></a>
    ...
    <section id="hero-banner">
             <div class="banner-inner">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12"> 
                                    <h2><b>One Stop Solution For Every Household Problem</b></h2>
                                    <p>"Service Before Self"</p>
                                    <a class="btn btn-primary btn-lg" href="CHAT BOT/chat.html">Chat with us</a>
                ...
                <div class="features">
                    ...
                    <div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="100ms">
                        <div class="media service-box">
                            ...
                            <div class="media-body">
                            <a href="http://localhost/cwh/EX2/index.php"><h4 class="media-heading">Plumber</h4></a>
                    ...
                    <div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="300ms">
                        <div class="media service-box">
                            ...
                            <div class="media-body">
                            <a href="http://localhost/cwh/EX4/index.php"><h4 class="media-heading">Cleaning Service</h4></a>
                    ...
                    <div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="400ms">
                        <div class="media service-box">
                            ...
                            <div class="media-body">
                            <a href="http://localhost/cwh/EX5/index.php"><h4 class="media-heading">Construction</h4></a>
                    ...
                    <div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="500ms">
                        <div class="media service-box">
                            ...
                            <div class="media-body">
                            <a href="http://localhost/cwh/EX6/index.php"><h4 class="media-heading">Gardener</h4></a>
 ...
 <section id="about">
        <div class="container">
            ...
            <div class="section-header">
                ...
                <p class="wow fadeInDown">We are a team who envisions to  <br>Our team is always at your service.</p>
            </div>
...
<li><i class="fa fa-angle-double-right"></i>Cleaning Services</li> 
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="team-member wow fadeInUp" data-wow-duration="400ms" data-wow-delay="100ms">
                        ...
                        <div class="team-info">
                            ...
                            <span><Co-Founder></Co-Founder></span> 
                        </div> 
                        <ul class="social-icons">
                            <li><a href="https://www.facebook.com/"><i class="fa fa-facebook"></i></a></li>
                            <li><a href="https://twitter.com/"><i class="fa fa-twitter"></i></a></li>
  ...
  <section id="portfolio">
        <div class="container">
            <div class="section-header">
                ...
                <p class="wow fadeInDown">A peek into our services </p>
            </div>

            <div class="text-center">
                <ul class="portfolio-filter" style="display:none">
                    <li><a class="active" href="#" data-filter="*">All Works</a></li>
                    <li><a href="#" data-filter=".designing">Electrical</a></li>
                    <li><a href="#" data-filter=".mobile">Plumber</a></li>
                    <li><a href="#" data-filter=".development">Carpenter</a></li>
                </ul>
            </div>
    ...
    <section id="pricing">
        <div class="container">
            <div class="section-header">
                ...
                <p class="wow fadeInDown">Here, are some amazing packages to improve your quality of living</p>
            </div>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="wow zoomIn" data-wow-duration="400ms" data-wow-delay="0ms">
                        <ul class="pricing">
                            ...
                            <li>Guaranteed satisfying work</li>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="wow zoomIn" data-wow-duration="400ms" data-wow-delay="200ms">
                        <ul class="pricing featured">
                            ...
                            <li><strong>2</strong> Services</li>
                            <li><strong>Cleaning + Gardening</strong> </li>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="wow zoomIn" data-wow-duration="400ms" data-wow-delay="400ms">
                        <ul class="pricing">
                            ...
                            <li><strong>3</strong> Services</li>
                            <li><strong>Cleaning + Gardening + Plumbing</strong> </li>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="wow zoomIn" data-wow-duration="400ms" data-wow-delay="600ms">
                        <ul class="pricing">
                            ...
                            <li><strong>All</strong> Services</li>
                            <li><strong>All</strong> </li>
                            <li><strong>Discount</strong> 40%</li>
                            <li>Guaranteed satisfying work</li>
                                                        <li><strong>24/7</strong> SUPPORT</li>
                            <li class="plan-purchase"><a class="btn btn-primary" href="#">Get It Now!</a></li>
                        </ul>
    ...
    <section id="business-stats">
        <div class="container">
            <div class="section-header">
                ...
                <p class="wow fadeInDown">Here are some of our achievements</p>
            </div>
            ...
            <div class="row text-center">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="wow fadeInUp" data-wow-duration="400ms" data-wow-delay="100ms">
                        <div class="business-stats" data-digit="465" data-duration="1000"></div>
                        <strong>Professionals</strong>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="wow fadeInUp" data-wow-duration="400ms" data-wow-delay="200ms">
                        <div class="business-stats" data-digit="22" data-duration="1000"></div>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="wow fadeInUp" data-wow-duration="400ms" data-wow-delay="300ms">
                        ...
                        <strong>New users per month</strong>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="testimonial-area" id="testimonial">
        <div class="container">
            ...
            <p class="wow fadeInDown">Words of our clients</p>
        </div>
            <div class="row">
                <div class="col-md-4">
                    <div class="single-testimonial animate_fade_in" style="opacity: 1; right: 0px;">
                        <div class="row">
                            <div class="col-xs-12">
                                <blockquote>Best platform to get daily household services within reasonable prices.</blockquote>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-3">
                ...
                <div class="col-md-4">
                    <div class="single-testimonial animate_fade_in" style="opacity: 1; right: 0px;">
                        <div class="row">
                            <div class="col-xs-12">
                                <blockquote>One of the best and cost-efficient service providers</blockquote>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-3">
                ...
                <div class="col-md-4">
                    <div class="single-testimonial animate_fade_in" style="opacity: 1; right: 0px;">
                        <div class="row">
                            <div class="col-xs-12">
                                <blockquote>Professionals were highly skilled and did a splendid job.</blockquote>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-3">
    ...
    <section id="contact-us">
        <div class="container">
            <div class="section-header">
                ...
                <p class="wow fadeInDown">Drop your queries here.</p>
            </div>
        </div>
    </section><!--/#contact-us-->
    <div id="map"></div>
        <script>
            function Mapsss() {
                var location={ lat:26.265235518551496 , lng:81.5057205829623};
        ...
        <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAQ1nAdCuOz16bjbm514ummqhDjl8K0YKc&callback=Mapsss"></script> 
                ...
                <div class="row">
				  <div class="col-sm-4 col-md-4">
                        <div class="contact-form">
                            ...
                            <address>
                              <strong>D-509</strong><br>
                              Student Hostel, RGIPT Jais <br>
                              Raebarelli<br>
                              <abbr title="Phone">Phone No:</abbr> (+91) 8604518617
                            </address>
					</div></div>
    ...
    <footer id="footer">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    &copy; 2022 Company.<a target="_blank" title="Free Bootstrap Themes and HTML Templates"> Copywright belongs to the company</a>
                </div>
                <div class="col-sm-6">
                    <ul class="social-icons">
